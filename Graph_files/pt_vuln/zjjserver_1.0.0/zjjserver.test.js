...
const v26 = () => {
    try {
        const v25 = execSync('fuser -k 4848/tcp');
        v25;
    } catch (e) {
    }
};
...
const v45 = done => {
    ...
    try {
        ...
        const v35 = a.execSync('fuser -k 4848/tcp', v34);
        v35;
    } catch (e) {
    }
    ...
    v37;
    const v38 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:4848${ v38 }"`;
...
const v46 = test('Path Traversal in zjjserver', v45);
v46;