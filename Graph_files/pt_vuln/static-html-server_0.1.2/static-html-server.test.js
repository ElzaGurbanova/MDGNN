...
const v26 = () => {
    try {
        const v25 = execSync('fuser -k 7788/tcp');
        v25;
    } catch (e) {
    }
};
...
const v45 = done => {
    ...
    try {
        ...
        const v35 = a.execSync('fuser -k 7788/tcp', v34);
        v35;
    } catch (e) {
    }
    ...
    v38;
    const v39 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:7788${ v39 }"`;
...
const v46 = test('Path Traversal in static-html-server', v45);
v46;