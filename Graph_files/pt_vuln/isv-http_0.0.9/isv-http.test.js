...
const v31 = done => {
    ...
    try {
        ...
        const v23 = a.execSync('fuser -k 9527/tcp', v22);
        v23;
    } catch (e) {
    }
    const v24 = pkg.runserver();
    v24;
    const v25 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:9527${ v25 }"`;
...
const v32 = test('Path Traversal in isv-http', v31);
v32;