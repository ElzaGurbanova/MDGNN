...
const v33 = done => {
    ...
    try {
        ...
        const v24 = a.execSync('fuser -k 8888/tcp', v23);
        v24;
    } catch (e) {
    }
    const v25 = require('api-proxy');
    const v26 = v25.start(8888);
    v26;
    const v27 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8888${ v27 }"`;
...
const v34 = test('Path Traversal in api-proxy', v33);
v34;