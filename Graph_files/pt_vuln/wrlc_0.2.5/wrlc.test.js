...
const v35 = done => {
    ...
    try {
        ...
        const v25 = a.execSync('fuser -k 8972/tcp', v24);
        v25;
    } catch (e) {
    }
    const v26 = {
    ...
    const v28 = pkg.serve(v26, v27);
    v28;
    const v29 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8972${ v29 }"`;
...
const v36 = test('Path Traversal in wrlc', v35);
v36;