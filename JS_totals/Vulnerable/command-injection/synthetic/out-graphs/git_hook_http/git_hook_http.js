...
const v103 = (req, res) => {
    ...
    const v89 = v88.repo;
    const v90 = v89 || '';
    const repo = String(v90);
    const v91 = parsed.query;
    const v92 = v91.hook;
    const v93 = v92 || '';
    const hook = String(v93);
    const v94 = 'git --git-dir=' + repo;
    const v95 = v94 + ' ';
    const cmd = v95 + hook;
...
const v105 = () => {
    const v104 = console.log('Listening http://127.0.0.1:8101/git/hook');
    return v104;
};
const v106 = server.listen(8101, v105);
v106;