...
const v103 = (req, res) => {
    ...
    const v89 = v88.url;
    const v90 = v89 || '';
    const target = String(v90);
    const v91 = parsed.query;
    const v92 = v91.out;
    const v93 = v92 || '/tmp/out.html';
    const out = String(v93);
    const v94 = 'curl -L ' + target;
    const v95 = v94 + ' -o ';
    const cmd = v95 + out;
    const v101 = err => {
...
const v105 = () => {
    const v104 = console.log('Listening http://127.0.0.1:8104/curl');
    return v104;
};
const v106 = server.listen(8104, v105);
v106;