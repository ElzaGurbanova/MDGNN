'use strict';
/**
 * HTTP endpoint that proxies simple VCS actions — FIXED (safer design)
...
const server = http.createServer((req, res) => {
  ...
  if (parsed.pathname !== '/vcs') { res.statusCode = 404; return res.end('not found'); }
...
server.listen(8081, () => console.log('Fixed server on 8081/vcs'));
