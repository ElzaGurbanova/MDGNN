...
export const DEFAULT_OPTIONS = {
  decode: [
    { regex: /%2e/g, replacement: '.' },
    { regex: /%2f/g, replacement: '/' },
    { regex: /%5c/g, replacement: '\\' }
  ],
 ...
 */
export default function sanitize(pathstr, options = DEFAULT_OPTIONS) {
  if (!options) options = DEFAULT_OPTIONS
  if (typeof options !== 'object') throw new Error('options must be an object')
  if (!Array.isArray(options.decode)) options.decode = DEFAULT_OPTIONS.decode
  ...
  // Remove ./ or / at start and trailing traversal patterns
  while (
