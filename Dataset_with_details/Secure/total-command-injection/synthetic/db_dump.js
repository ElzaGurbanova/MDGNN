'use strict';
/**
 * HTTP endpoint to export database tables — FIXED (safer design)
...
const server = http.createServer((req, res) => {
  ...
  if (parsed.pathname !== '/db/dump') { res.statusCode = 404; return res.end('not found'); }
...
server.listen(8081, () => console.log('Fixed server on 8081/db/dump'));
