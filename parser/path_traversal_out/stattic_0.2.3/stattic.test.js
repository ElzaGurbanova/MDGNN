...
const v35 = done => {
    ...
    try {
        ...
        const v25 = a.execSync('fuser -k 8977/tcp', v24);
        v25;
    } catch (e) {
    }
    const v26 = stattic.set('folder', '.');
    v26;
    const v27 = stattic.set('port', 8977);
    v27;
    const v28 = stattic.listen();
    v28;
    const v29 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8977${ v29 }"`;
...
const v36 = test('Path Traversal in stattic', v35);
v36;