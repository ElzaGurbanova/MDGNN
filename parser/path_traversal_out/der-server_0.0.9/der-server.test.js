...
const v31 = done => {
    ...
    try {
        ...
        const v23 = a.execSync('fuser -k 8887/tcp', v22);
        v23;
    } catch (e) {
    }
    const v24 = pkg.start(__dirname, '../flag.html', 8887);
    v24;
    const v25 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8887${ v25 }"`;
...
const v32 = test('Path Traversal in der-server', v31);
v32;