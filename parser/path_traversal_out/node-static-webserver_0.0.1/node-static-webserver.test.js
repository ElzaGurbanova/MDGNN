...
const v31 = done => {
    ...
    try {
        ...
        const v23 = a.execSync('fuser -k 8984/tcp', v22);
        v23;
    } catch (e) {
    }
    const v24 = new pkg(__dirname, 8984, '127.0.0.1');
    v24;
    const v25 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8984${ v25 }"`;
...
const v32 = test('Path Traversal in node-static-webserver', v31);
v32;