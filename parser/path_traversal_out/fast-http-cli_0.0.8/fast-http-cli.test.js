...
const v25 = () => {
    try {
        const v24 = execSync('fuser -k 8892/tcp');
        v24;
    } catch (e) {
    }
};
...
const v43 = done => {
    ...
    try {
        ...
        const v34 = a.execSync('fuser -k 8892/tcp', v33);
        v34;
    } catch (e) {
    }
    ...
    v36;
    const v37 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8892${ v37 }"`;
...
const v44 = test('Path Traversal in fast-http-cli', v43);
v44;