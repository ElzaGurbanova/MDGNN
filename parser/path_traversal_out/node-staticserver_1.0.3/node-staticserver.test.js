...
const v31 = done => {
    ...
    try {
        ...
        const v23 = a.execSync('fuser -k 8983/tcp', v22);
        v23;
    } catch (e) {
    }
    let app = pkg();
    const v24 = app.listen(8983);
    v24;
    const v25 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8983${ v25 }"`;
...
const v32 = test('Path Traversal in node-staticserver', v31);
v32;