...
const v33 = done => {
    ...
    try {
        ...
        const v24 = a.execSync('fuser -k 8986/tcp', v23);
        v24;
    } catch (e) {
    }
    const v25 = {
    ...
    const v26 = pkg.deploy(v25);
    v26;
    const v27 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8986${ v27 }"`;
...
const v34 = test('Path Traversal in node-http-server', v33);
v34;