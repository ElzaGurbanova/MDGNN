...
const v33 = done => {
    ...
    try {
        ...
        const v24 = a.execSync('fuser -k 10001/tcp', v23);
        v24;
    } catch (e) {
    }
    const v25 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:10001${ v25 }"`;
    const v26 = {
        host: 'localhost',
        port: 10001
    };
    const v27 = server(v26);
    v27;
...
const v34 = test('Path Traversal in rollup-plugin-dev-server', v33);
v34;