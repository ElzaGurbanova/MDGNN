...
const v31 = done => {
    ...
    try {
        ...
        const v23 = a.execSync('fuser -k 8973/tcp', v22);
        v23;
    } catch (e) {
    }
    const v24 = pkg.run(8973, __dirname);
    v24;
    const v25 = genstr();
    let attack_string = `curl -v --path-as-is "http://127.0.0.1:8973${ v25 }"`;
...
const v32 = test('Path Traversal in willvdb_test_server', v31);
v32;